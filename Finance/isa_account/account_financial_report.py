...
class account_financial_report(osv.osv):
    ...
    _columns = {
        ...
        'balance_usd': fields.function(_get_balance, 'Balance', multi='balance'),
        'debit_usd': fields.function(_get_balance, 'Debit', multi='balance'),
        'credit_usd': fields.function(_get_balance, 'Credit', multi="balance"),
