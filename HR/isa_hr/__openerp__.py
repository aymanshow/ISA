 
{
    ...
    'data':[
            ...
            'wizard/hr_applicant_wizard_view.xml',
             ...
             'form_sequence.xml',
             'isa_survey_view.xml',  
             'isa_hr_recruitment_menuitem.xml', 
             'form_sequence.xml',  
             'isa_survey_view.xml',
              
             'employee_contract_view.xml',
             'demo_data.xml',
              'data/hr_job_template.xml',
              'data/joining_process_template.xml',
              'data/medical_test_template.xml',
              'data/recruitment_done_template.xml',
              'data/test_mail_template.xml',
              ],
    'installable':True,
    'auto_install':False,
    'application':True,
