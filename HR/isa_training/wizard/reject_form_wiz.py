...
class rejected_form_training(osv.osv):
    _name='rejected.form.training'
#     _inherit='hr.applicant'
    _columns={
              'name_id':fields.char('Employee Name',readonly=True),
...
# function for getting the default value of the stage in the wizard
    def default_get(self, cr, uid, fields, context=None):
        ...
        if applicant_ids:
            ...
            st_name=applicant_obj.emp_name_id
            subject_id=applicant_obj.emp_id
            req_id=applicant_obj.department_id
...
#          hr_appli_obj=self.pool.get('employee.training1')
         ...
         record_id11=value1.search(cr ,uid ,[('training_state','=','refuse')],context=context)
...
#          value1.write(cr, uid, applicant_ids[0],{'stage_id':obj.id})
         ...
         self.write(cr, uid, ids,{'name_id':wiz_obj.emp_name_id,
                                  'requestion_id1':wiz_obj.emp_id,
                                  'partner_name':wiz_obj.department_id,
                                  'training_state':wiz_obj.training_state,
                                                         } ,context=context)
         return res
