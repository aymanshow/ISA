...
class survey_page(osv.osv):
    ...
    _rec_name = 'title'
    _order = 'sequence'
    def _marks_total(self, cr, uid, ids, field_name, arg, context=None):
         res = {}
         if context is None:
            context = {}
         for line in self.browse(cr, uid, ids, context=context):
             total=total1=0.0
             for val in line.question_ids:
                 total+=val.basic_fees
                 total1+=val.fees
    ...
    _columns = {
        ...
        'result': fields.function(_marks_total, string='Total Marks',),
...
#    _order = 'sequence'
    ...
    _columns = {
        ...
        'sequence':fields.function( _seq_no , string='Sr.No.', type='integer',size=10,method=True,),
