...
class mail_compose_message1(osv.TransientModel):
    ...
    def default_get(self, cr, uid, fields, context=None):
        ...
        if context is None:
            context = {}
        result = super(mail_compose_message1, self).default_get(cr, uid, fields, context=context)
        ...
        email_obj=self.pool.get('hr.applicant').browse(cr,uid,context['active_id'])
        print'===========',email_obj,email_obj.email_from
        print'===========',email_obj.doctor_name.email
        test=[]
    ...
    _columns = {
        ...
        'partner_ids': fields.many2many('res.partner',
            'mail_compose_message_res_partner_rel1',
            'wizard_id', 'partner_id', 'Additional contacts'),
        'attachment_ids': fields.many2many('ir.attachment',
            'mail_compose_message_ir_attachments_rel1',
    ...
    def check_access_rule(self, cr, uid, ids, operation, context=None):
        ...
        return super(mail_compose_message1, self).check_access_rule(cr, uid, ids, operation, context=context)
    ...
    def get_message_data(self, cr, uid, message_id, context=None):
        ...
        partner_ids = [partner for partner in message_data.partner_ids] if message_data.partner_ids else []
