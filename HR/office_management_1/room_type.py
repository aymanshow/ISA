...
#        return res
    ...
    _columns ={
               ...
               'guest_name':fields.char('Guest Name',size=64,required=True),
    ...
    def default_get(self, cr, uid, fields, context=None):
        ...
        return res
#    def on_change_manufature(self,cr,uid,ids,manufacture_id,context=None):
#        res={}
#        if not manufacture_id:
#            return {}
#        ids=self.pool.get('fleet.vehicle').search(cr,uid,[('model_id','=',manufacture_id)])
#        res['domain'] = {'license_plate_id': [('id', 'in', ids)]}
#        return res
#    
#    def on_change_license_plate(self,cr,uid,ids,license_plate_id,context=None):
#        res={}
#        if not license_plate_id:
#            return {}
#        obj=self.pool.get('fleet.vehicle').browse(cr,uid,license_plate_id)
#        id=obj.driver_id.id
#        partner_obj=self.pool.get('res.partner').browse(cr,uid,id)
