...
class hr_payslip_report(osv.osv_memory):
    #_inherit = "hr.payslip.report"
    _name = "hr.payslip.report"
    _description = "Payslip Reports"

    _columns = {
          'name':fields.char('Payslip Report name'),
          'number':fields.integer('Payslip No.'),      
